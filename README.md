...
* wget
  ...
  ```sh
  wget --no-check-certificate -O ${HOME}/Xray-script.sh https://raw.githubusercontent.com/sjwayrhz/v2ray-config/master/reality.sh && bash ${HOME}/Xray-script.sh
  ```

* curl

  ```sh
  curl -fsSL -o ${HOME}/Xray-script.sh https://raw.githubusercontent.com/sjwayrhz/v2ray-config/master/reality.sh && bash ${HOME}/Xray-script.sh
  ```
